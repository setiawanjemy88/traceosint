# traceosint
Trace osint locator
[](/)[My Projects](/profile)[leaderboardLeaderboards](https://designarena.ai/leaderboard)[Models](/models)[About](/about)Recent Designs[Real-Time Network & Surveillance Dashboard](/chat/7972558d-7dee-47f9-ac92-3d887ef9a718)[Termux Linux Cheatsheet with Mapscii](/chat/2cef966a-2375-4a42-a67c-c00f43e32bd7)[Trace osint jemy](/chat/f805c44b-1ead-4e73-b67c-3711f823b581)[Darkweb Dorking Hub](/chat/e897d136-a6a6-405d-bdb2-d40ff3bd3c90)[Hijau OSINT Locator](/chat/e95d083d-d02f-44fb-b555-e7b1dcb7d0dd)[Smart Location Finder App](/chat/bd0b95f2-e165-4fb9-9907-45ac18fefbb2)![Profile](https://lh3.googleusercontent.com/a/ACg8ocISLagoZctcNJZuxON1q10tYU2XN0NQYCifnhUChK3E01wpc5DtNw=s96-c)Jemy Setiawan![GLM 5.1](/model-logos/zai-org.svg)GLM 5.1publicfavicon.svgvite.svgsrcassetsreact.svgcomponentsMapView.tsxScanTerminal.tsxlibosintEngine.tsApp.tsxindex.cssmain.tsx.gitignore.vite-source-tags.jseslint.config.jsindex.htmlpackage-lock.jsonpackage.jsonREADME.mdtsconfig.app.jsontsconfig.jsontsconfig.node.jsonvite.config.tstsconfig.app.json1234{  "compile  rOptions  ": {    "tsBui    ldInfo    File":     "./    node_m    odules    /.tmp/    tsconf    ig.    app.    tsbuil    dinfo"    ,    "targe/mnt/efs/sessions/c8011d16-719b-42fd-ad77-5ba97c5a426c/agent_2(110ms)$cat package.json && echo "---" && ls -la src/ && echo "---" && cat src/App.tsx{
  "name": "placeholder-model-1",
  "private": true,
  "version": "0.0.0",
  "type": "module",
  "scripts": {
...
---
total 28
drwxr-xr-x. 3 agent 1000 6144 Aug  7 16:51 .
drwxr-xr-x. 5 agent 1000 6144 Aug  7 16:53 ..
-rw-r--r--. 1 agent 1000    0 Aug  7 16:51 App.css
-rw-r--r--. 1 agent 1000  903 Aug  7 16:51 App.tsx
drwxr-xr-x. 2 agent 1000 6144 Aug  7 16:51 assets
-rw-r--r--. 1 agent 1000   23 Aug  7 16:51 index.css
-rw-r--r--. 1 agent 1000  230 Aug  7 16:51 main.tsx
---
...
export default App
/mnt/efs/sessions/c8011d16-719b-42fd-ad77-5ba97c5a426c/agent_2(4819ms)$npm install leaflet @types/leaflet 2>&1 | tail -5Run `npm audit` for details.
npm warn install-scripts 1 package has install scripts not yet covered by allowScripts:
npm warn install-scripts   esbuild@0.28.1 (postinstall: node install.js)
npm warn install-scripts
npm warn install-scripts Run `npm install-scripts ls` to review, or `npm install-scripts approve <pkg>` to allow.
/mnt/efs/sessions/c8011d16-719b-42fd-ad77-5ba97c5a426c/agent_2(60ms)$cat index.html<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <link rel="icon" type="image/svg+xml" href="/vite.svg" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>placeholder-model-1</title>
  </head>
  <body>
    <div id="root"></div>
...
/mnt/efs/sessions/c8011d16-719b-42fd-ad77-5ba97c5a426c/agent_2(40310ms)$rm -f src/App.css && npm run build 2>&1
> placeholder-model-1@0.0.0 build
> tsc -b && vite build
...
dist/assets/index-cgqFDLX9.css   46.50 kB │ gzip:  12.86 kB
dist/assets/index-Dn6IPnSG.js   516.54 kB │ gzip: 160.35 kB
...
✓ built in 13.11s
Buat aplikasi pencarian lokasi dengan map secara akurat berdasarkan no handphone, username dan email. Dengan tema hijau seperti osint finder

![GLM 5.1](/model-logos/zai-org.svg)GLM 5.1Website artifactDone. Built **TRACE.OSINT** — a geolocation intelligence console with a green hacker/terminal aesthetic inspired by OSINT finder tools.
